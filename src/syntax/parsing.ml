...
type 'a nonterminal = 'a Parser.MenhirInterpreter.nonterminal =
  ...
  | N_stmt_
      : ( (Untyped_ast.Pattern.t Node.t * Fixity.t option * Untyped_ast.Expr.t Node.t)
          Nonempty.t
  ...
  | N_separated_nonempty_list_PIPE_match_branch_
      : (Untyped_ast.Pattern.t Node.t * Untyped_ast.Expr.t Node.t) list nonterminal
  | N_separated_nonempty_list_PIPE_handle_branch_
      : ([ `Effect of Untyped_ast.Effect_pattern.t | `Value of Untyped_ast.Pattern.t ]
         Node.t
        * Untyped_ast.Expr.t Node.t)
        list
        nonterminal
  ...
  | N_separated_nonempty_list_AND_let_binding_
      : (Untyped_ast.Pattern.t Node.t * Fixity.t option * Untyped_ast.Expr.t Node.t) list
        nonterminal
  | N_separated_nonempty_list_AMPERSAND_type_non_fun_
      : Parser_scope.Module_path.relative Type_scheme.type_ list nonterminal
  | N_qualified_with_loc_tuple_expr___
      : (Ustring.t list * Untyped_ast.Expr.t Node.t list Node.t) nonterminal
  | N_qualified_val_name_ : (Ustring.t list * Ustring.t) nonterminal
  | N_qualified_parens_with_loc_op_section___
      : (Ustring.t list * Untyped_ast.Expr.t Node.t) nonterminal
  ...
  | N_prog : Untyped_ast.Module.t nonterminal
  | N_pattern_term : Untyped_ast.Pattern.t nonterminal
  | N_pattern_name : Parser_scope.Value_name.t option nonterminal
  | N_pattern : Untyped_ast.Pattern.t nonterminal
  ...
  | N_option_preceded_EQUALS_pattern__ : Untyped_ast.Pattern.t option nonterminal
  | N_option_preceded_EQUALS_expr__ : Untyped_ast.Expr.t Node.t option nonterminal
  ...
  | N_op_section : Untyped_ast.Expr.t nonterminal
  | N_nonempty_list_with_loc_pattern_term__
      : Untyped_ast.Pattern.t Node.t list nonterminal
  | N_nonempty_list_with_loc_pattern__ : Untyped_ast.Pattern.t Node.t list nonterminal
  | N_nonempty_list_with_loc_expr_term__ : Untyped_ast.Expr.t Node.t list nonterminal
  | N_nonempty_list_type_term_
      : Parser_scope.Module_path.relative Type_scheme.type_ list nonterminal
  | N_nonempty_list_pattern_term_ : Untyped_ast.Pattern.t list nonterminal
  | N_nonempty_list_LOWER_NAME_ : Ustring.t list nonterminal
  | N_n_periods : int nonterminal
  | N_match_branches
      : (Untyped_ast.Pattern.t Node.t * Untyped_ast.Expr.t Node.t) Nonempty.t nonterminal
  | N_match_branch
      : (Untyped_ast.Pattern.t Node.t * Untyped_ast.Expr.t Node.t) nonterminal
  ...
  | N_flexible_nonempty_COMMA_record_field_EQUALS_pattern__
      : (Parser_scope.Value_name.t * Untyped_ast.Pattern.t option) Nonempty.t nonterminal
  | N_flexible_nonempty_COMMA_record_field_EQUALS_expr__
      : (Parser_scope.Value_name.t * Untyped_ast.Expr.t Node.t option) Nonempty.t
        nonterminal
  | N_flexible_nonempty_COMMA_pattern_ : Untyped_ast.Pattern.t Nonempty.t nonterminal
  | N_flexible_nonempty_COMMA_expr_ : Untyped_ast.Expr.t Node.t Nonempty.t nonterminal
  ...
  | N_flexible_list_COMMA_record_field_EQUALS_pattern__
      : (Parser_scope.Value_name.t * Untyped_ast.Pattern.t option) list nonterminal
  | N_flexible_list_COMMA_record_field_EQUALS_expr__
      : (Parser_scope.Value_name.t * Untyped_ast.Expr.t Node.t option) list nonterminal
  | N_flexible_list_COMMA_pattern_ : Untyped_ast.Pattern.t list nonterminal
  | N_flexible_list_COMMA_expr_ : Untyped_ast.Expr.t Node.t list nonterminal
  | N_fixity : Fixity.t nonterminal
  | N_expr_term : Untyped_ast.Expr.t nonterminal
  | N_expr_op_tree
      : (Parser_scope.Value_name.Relative.t Node.t, Untyped_ast.Expr.t Node.t) Btree.t
        nonterminal
  | N_expr_op_term : Untyped_ast.Expr.t nonterminal
  | N_expr_ : Untyped_ast.Expr.t nonterminal
