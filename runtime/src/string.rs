...
// TODO: The current design of the effects runtime can't handle external calls back into
...
//
// It should be ok as long as the closure doesn't try to perform effects across the FFI
// boundary. It should be ok if it performs some effects but handles them internally.
#[no_mangle]
